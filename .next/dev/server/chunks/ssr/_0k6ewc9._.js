...
var useMegaStorage = ()=>{
    ...
    var [hasAttemptedConnect, setHasAttemptedConnect] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    var connectToMega = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(/*#__PURE__*/ _asyncToGenerator(function*() {
        ...
        try {
            ...
            var { Storage } = yield __turbopack_context__.A("[project]/node_modules/megajs/dist/main.node-es.mjs [app-ssr] (ecmascript, async loader)");
            ...
            console.debug('Mega connection failed (expected in some environments):', err.message);
            setError(null);
    ...
    var uploadFile = /*#__PURE__*/ function() {
        var _ref2 = _asyncToGenerator(function*(file, onProgress, abortController) {
            try {
                var connected = isConnected;
                if (!connected) {
                    connected = yield connectToMega();
                }
                ...
                if (abortController) {
                    var handleAbort = ()=>{
                        ...
                        // 尝试取消上传
                        (_upload$abort = upload.abort) === null || _upload$abort === void 0 || _upload$abort.call(upload);
                    };
                ...
                upload.on('progress', (progress)=>{
                    ...
                    console.log("Mega upload progress: ".concat(Math.round(progress * 100), "%"));
                    if (onProgress) {
                        onProgress(progress);
                    }
                });
                ...
                var arrayBuffer = yield file.arrayBuffer();
                // 检查是否已取消
                if (abortController !== null && abortController !== void 0 && abortController.signal.aborted) {
                    return null;
                }
                ...
                upload.write(buffer);
                upload.end();
                var uploadedFile = yield upload.complete;
                console.log('File uploaded to Mega successfully');
                return uploadedFile.link;
            } catch (err) {
                console.debug('Mega upload failed:', err.message);
                setError(null);
                return null;
            }
        });
    ...
    var downloadFile = /*#__PURE__*/ function() {
        var _ref3 = _asyncToGenerator(function*(fileLink) {
            try {
                ...
                var data = yield file.downloadBuffer();
                return new Blob([
                    data
                ]);
            } catch (err) {
                console.debug('Mega download failed:', err.message);
                setError(null);
                return null;
            }
        });
    ...
    var deleteFile = /*#__PURE__*/ function() {
        var _ref4 = _asyncToGenerator(function*(fileLink) {
            try {
                if (!isConnected || !megaStorage) {
                    return false;
                }
                ...
                console.debug('Mega delete failed:', err.message);
                return false;
            }
        });
...
function FileManager() {
        ...
        var _ref = _asyncToGenerator(function*(uploadedFiles) {
            ...
            if (megaFiles.length > 0) {
                ...
                try {
                    ...
                    console.error('Mega upload failed:', error1);
        ...
        var _ref2 = _asyncToGenerator(function*() {
            ...
            if (selectedFile.url && selectedFile.url !== '#' && selectedFile.url !== '') {
                try {
                    ...
                    console.error('Error downloading file:', error1);
                    setIsDownloading(false);
                    setDownloadProgress(0);
                    setDownloadingFileName('');
                    alert('文件下载失败，请重试。');
    ...
    var handleMegaFileUpload = /*#__PURE__*/ function() {
        var _ref8 = _asyncToGenerator(function*(file) {
            ...
            try {
                ...
                var megaLink = yield uploadFile(file, (progress)=>{
                ...
                console.error('Mega upload failed:', error1);
                var errorMessage = error1 instanceof Error ? error1.message : '上传失败，请重试';
    ...
    return /*#__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].createElement(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].Fragment, null, /*#__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].createElement(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$layout$2f$MobileLayout$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
        ...
        error: uploadError,
        status: isTimeout ? 'timeout' : error ? 'error' : 'uploading'
    }));
}
}),
...
//# sourceMappingURL=_0k6ewc9._.js.map