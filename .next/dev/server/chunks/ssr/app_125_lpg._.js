...
var Icon = (_ref3)=>{
    ...
    if (name === 'folder') {
        ...
        return /*#__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].createElement(LazyImage, {
            src: folderImagePath,
            alt: "folder",
            width: size,
            height: size,
...
"[project]/app/hooks/useFileOperations.ts [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {

const e = new Error("Could not parse module '[project]/app/hooks/useFileOperations.ts', file not found");
...
function FileManager() {
    ...
    // 初始化自定义hooks
    var { loadFilesFromStorage, saveFilesToStorage } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$hooks$2f$useFileStorage$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useFileStorage"])();
    ...
    var handleFilesUploadedWrapper = /*#__PURE__*/ function() {
        var _ref = _asyncToGenerator(function*(uploadedFiles) {
            // 检查是否有大文件（超过1GB）
            var largeFiles = uploadedFiles.filter((file)=>file.size > 1024 * 1024 * 1024);
            if (largeFiles.length > 0) {
                alert("\u6587\u4EF6 \"".concat(largeFiles[0].name, "\" \u8D85\u8FC7\u4E861GB\u7684\u5927\u5C0F\u9650\u5236\uFF0C\u65E0\u6CD5\u4E0A\u4F20\u3002"));
                // 过滤掉大文件，只上传符合大小限制的文件
...
//# sourceMappingURL=app_125_lpg._.js.map