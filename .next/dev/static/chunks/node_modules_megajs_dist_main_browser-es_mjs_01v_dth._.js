...
"[project]/node_modules/megajs/dist/main.browser-es.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var require_browser = __commonJS({
    "node_modules/abort-controller/browser.js" (exports, module) {
        "use strict";
        init_process_shim();
        var { AbortController: AbortController2, AbortSignal } = typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : /* otherwise */ void 0;
...
var require_events = __commonJS({
    "node_modules/events/events.js" (exports, module) {
        ...
        function _getMaxListeners(that) {
            if (that._maxListeners === void 0) return EventEmitter4.defaultMaxListeners;
...
var require_validators = __commonJS({
    "node_modules/readable-stream/lib/internal/validators.js" (exports, module) {
        ...
        var { hideStackFrames, codes: { ERR_SOCKET_BAD_PORT, ERR_INVALID_ARG_TYPE: ERR_INVALID_ARG_TYPE2, ERR_INVALID_ARG_VALUE, ERR_OUT_OF_RANGE, ERR_UNKNOWN_SIGNAL } } = require_errors();
    ...
    "node_modules/readable-stream/lib/internal/streams/from.js" (exports, module) {
        ...
        function from(Readable, iterable, opts) {
            ...
            readable._destroy = function(error, cb) {
                PromisePrototypeThen(close(error), ()=>process2.nextTick(cb, error), // nextTick is here in case cb throws
...
var require_readable = __commonJS({
    "node_modules/readable-stream/lib/internal/streams/readable.js" (exports, module) {
        ...
        var { aggregateTwoErrors, codes: { ERR_INVALID_ARG_TYPE: ERR_INVALID_ARG_TYPE2, ERR_METHOD_NOT_IMPLEMENTED, ERR_OUT_OF_RANGE, ERR_STREAM_PUSH_AFTER_EOF, ERR_STREAM_UNSHIFT_AFTER_END_EVENT }, AbortError } = require_errors();
...
var require_writable = __commonJS({
    "node_modules/readable-stream/lib/internal/streams/writable.js" (exports, module) {
        ...
        var { addAbortSignal } = require_add_abort_signal();
        var { getHighWaterMark, getDefaultHighWaterMark } = require_state();
        var { ERR_INVALID_ARG_TYPE: ERR_INVALID_ARG_TYPE2, ERR_METHOD_NOT_IMPLEMENTED, ERR_MULTIPLE_CALLBACK, ERR_STREAM_CANNOT_PIPE, ERR_STREAM_DESTROYED, ERR_STREAM_ALREADY_FINISHED, ERR_STREAM_NULL_VALUES, ERR_STREAM_WRITE_AFTER_END, ERR_UNKNOWN_ENCODING } = require_errors().codes;
        var { errorOrDestroy } = destroyImpl;
...
var require_duplexify = __commonJS({
    "node_modules/readable-stream/lib/internal/streams/duplexify.js" (exports, module) {
        ...
        var eos = require_end_of_stream();
        var { AbortError, codes: { ERR_INVALID_ARG_TYPE: ERR_INVALID_ARG_TYPE2, ERR_INVALID_RETURN_VALUE } } = require_errors();
...
var require_pipeline = __commonJS({
    "node_modules/readable-stream/lib/internal/streams/pipeline.js" (exports, module) {
        ...
        var destroyImpl = require_destroy();
        var Duplex = require_duplex();
        var { aggregateTwoErrors, codes: { ERR_INVALID_ARG_TYPE: ERR_INVALID_ARG_TYPE2, ERR_INVALID_RETURN_VALUE, ERR_MISSING_ARGS, ERR_STREAM_DESTROYED, ERR_STREAM_PREMATURE_CLOSE }, AbortError } = require_errors();
...
var require_operators = __commonJS({
    "node_modules/readable-stream/lib/internal/streams/operators.js" (exports, module) {
        ...
        init_process_shim();
        var AbortController2 = globalThis.AbortController || require_browser().AbortController;
        var { codes: { ERR_INVALID_ARG_VALUE, ERR_INVALID_ARG_TYPE: ERR_INVALID_ARG_TYPE2, ERR_MISSING_ARGS, ERR_OUT_OF_RANGE }, AbortError } = require_errors();
    ...
    "node_modules/duplexify/node_modules/readable-stream/lib/_stream_writable.js" (exports, module) {
        ...
        function validChunk(stream, state, chunk, cb) {
            ...
            if (chunk === null) {
                ...
                er = new ERR_INVALID_ARG_TYPE2("chunk", [
                    "string",
                    "Buffer"
                ], chunk);
            }
...
var require_duplexify2 = __commonJS({
    "node_modules/duplexify/index.js" (exports, module) {
        ...
        var SIGNAL_FLUSH = import_buffer.Buffer.from && import_buffer.Buffer.from !== Uint8Array.from ? import_buffer.Buffer.from([
            0
        ]) : new import_buffer.Buffer([
            0
        ]);
...
function chunkSizeSafe(size) {
    ...
    return new import_stream.Transform({
        transform (chunk, encoding, callback) {
            if (last) chunk = import_buffer.Buffer.concat([
                last,
                chunk
            ]);
            const end = Math.floor(chunk.length / size) * size;
            if (!end) {
                last = last ? import_buffer.Buffer.concat([
                    last,
                    chunk
                ]) : chunk;
...
function prepareKeyV2(password, info, cb) {
    ...
    Promise.resolve().then(()=>globalThis.crypto.subtle.importKey("raw", password, "PBKDF2", false, [
            "deriveKey",
            "deriveBits"
        ])).then((key)=>{
...
async function generateHashcashToken(challenge) {
    ...
    const buffer = import_buffer.Buffer.alloc(4 + 262144 * 48);
...
function RSAdecrypt(m, d, p, q, u) {
    const xp = bmodexp(bmod(m, p), bmod(d, bsub(p, [
        1
    ])), p);
    const xq = bmodexp(bmod(m, q), bmod(d, bsub(q, [
        1
    ])), q);
    let t = bsub(xq, xp);
    if (t.length === 0) {
...
var DEFAULT_HTTP_AGENT = ("TURBOPACK compile-time truthy", 1) ? null : "TURBOPACK unreachable";
var DEFAULT_HTTPS_AGENT = ("TURBOPACK compile-time truthy", 1) ? null : "TURBOPACK unreachable";
var API = class _API extends import_events.EventEmitter {
    ...
    pull(sn, retryno = 0) {
        ...
        this.sn = controller;
        this.fetch(`${this.gateway}sc?${new URLSearchParams({
            sn,
            ssl,
            sid: this.sid
        })}`, {
...
var MutableFile = class _MutableFile extends file_default {
    ...
    mkdir(opt, originalCb) {
        ...
        if (!opt.key) opt.key = import_buffer.Buffer.from(globalThis.crypto.getRandomValues(new Uint8Array(16)));
    ...
    upload(opt, source, originalCb) {
        ...
        if (!(key instanceof import_buffer.Buffer)) key = import_buffer.Buffer.from(key);
        ...
        const gotBuffer = (err, buffer)=>{
            ...
            if (rest !== 0) {
                buffer = import_buffer.Buffer.concat([
                    buffer,
                    import_buffer.Buffer.alloc(rest)
                ]);
            }
    ...
    delete(permanent, cb) {
        ...
        if (permanent) return this.api.request({
            a: "d",
            n: this.nodeId
        }, cb);
    ...
    importFile(sharedFile, originalCb) {
        ...
        if (typeof sharedFile === "string") sharedFile = file_default.fromURL(sharedFile);
        if (!(sharedFile instanceof file_default)) throw Error("First argument of importFile should be a File or a URL string");
        if (!sharedFile.key) {
...
function selfAndChildren(node) {
    return [
        node
    ].concat((node.children || []).map(selfAndChildren).reduce((arr, el)=>arr.concat(el), []));
}
...
var Storage = class _Storage extends import_events3.EventEmitter {
    ...
    reload(force, originalCb) {
        if (typeof force === "function") [force, originalCb] = [
            originalCb,
            force
        ];
        const [cb, promise] = createPromise(originalCb);
...
//# sourceMappingURL=node_modules_megajs_dist_main_browser-es_mjs_01v_dth._.js.map