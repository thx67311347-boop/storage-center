...
var useFileOperations = ()=>{
    ...
    var handleFilesUploaded = /*#__PURE__*/ function() {
        var _ref = _asyncToGenerator(function*(uploadedFiles, currentFolder, files, updateFiles, updateUsedStorage) {
            try {
                    ...
                    var _ref2 = _asyncToGenerator(function*(file) {
                        try {
                            ...
                            var newFile = {
                                ...
                                url: "data:".concat(file.type, ";base64,").concat(fileData.split(',')[1]),
                                // 使用base64 URL
        ...
        return function handleFilesUploaded(_x, _x2, _x3, _x4, _x5) {
            return _ref.apply(this, arguments);
        };
    }();
    // 清理文件URL对象，避免内存泄漏
    ...
    var handleFileDelete = /*#__PURE__*/ function() {
        var _ref3 = _asyncToGenerator(function*(fileId, isFromTrash, files, updateFiles, updateUsedStorage) {
        ...
        return function handleFileDelete(_x7, _x8, _x9, _x10, _x11) {
            return _ref3.apply(this, arguments);
        };
    }();
    // 处理多文件删除
    var handleMultiFileDelete = /*#__PURE__*/ function() {
        var _ref4 = _asyncToGenerator(function*(fileIds, isFromTrash, files, updateFiles, updateUsedStorage) {
            // 计算需要释放的存储空间
        ...
        return function handleMultiFileDelete(_x12, _x13, _x14, _x15, _x16) {
            return _ref4.apply(this, arguments);
        };
    }();
    // 处理文件重命名
    var handleFileRename = /*#__PURE__*/ function() {
        var _ref5 = _asyncToGenerator(function*(fileId, newName, files, updateFiles) {
            try {
                // 检查fileId是否为标准UUID格式，避免数据库操作错误
                var uuidRegex = /^[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/i;
                if (uuidRegex.test(fileId)) {
        ...
        return function handleFileRename(_x17, _x18, _x19, _x20) {
            return _ref5.apply(this, arguments);
        };
    }();
    // 处理文件恢复
    var handleFileRestore = /*#__PURE__*/ function() {
        var _ref6 = _asyncToGenerator(function*(fileId, files, updateFiles, updateUsedStorage) {
        ...
        return function handleFileRestore(_x21, _x22, _x23, _x24) {
    ...
    var handleFileDownload = /*#__PURE__*/ function() {
        ...
        return function handleFileDownload(_x25) {
            return _ref7.apply(this, arguments);
        };
    }();
    // 处理创建文件夹
    var handleCreateFolder = /*#__PURE__*/ function() {
        var _ref8 = _asyncToGenerator(function*(folderName, currentFolder, files, updateFiles) {
            try {
                var currentUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$hooks$2f$useFileStorage$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getCurrentUser"])();
                // 将文件夹信息保存到数据库
        ...
        return function handleCreateFolder(_x26, _x27, _x28, _x29) {
...
var useMegaStorage = ()=>{
    ...
    var uploadFile = /*#__PURE__*/ function() {
        var _ref2 = _asyncToGenerator(function*(file, onProgress) {
            try {
    ...
    var handleFilesUploadedWrapper = /*#__PURE__*/ function() {
        var _ref = _asyncToGenerator(function*(uploadedFiles) {
            ...
            if (megaFiles.length > 0) {
                ...
                try {
                    for (var _file2 of megaFiles){
                        setIsUploading(true);
                        setUploadingFileName(_file2.name);
                        setUploadProgress(0);
                        var megaLink = yield uploadFile(_file2, (progress)=>{
                        ...
                        if (megaLink) {
                            ...
                            dispatch({
                                type: 'SET_USED_STORAGE',
                                payload: usedStorage + _file2.size
                            });
                        }
                    }
                } catch (error) {
...
//# sourceMappingURL=_05cnd8p._.js.map