...
export default function Sidebar({ selectedSection, onSectionSelect, onSettingsClick, usedStorage, totalStorage }: SidebarProps) {
  ...
  return (
    <aside className="w-72 bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 h-full flex flex-col">
      <div className="p-4">
        <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">存储中心</h2>
