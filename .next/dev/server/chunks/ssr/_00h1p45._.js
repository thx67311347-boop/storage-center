        ...
        var _ref = _asyncToGenerator(function*(uploadedFiles) {
            try {
                ...
                for (var file of uploadedFiles){
                    ...
                    // 上传文件到 Supabase 存储
                    var { error: storageError } = yield __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].storage.from('files').upload(fileName, file);
                    if (storageError) {
                        console.error('Error uploading file:', storageError);
                        continue;
                    }
                    // 获取文件的公共 URL
                    var { data: urlData, error: urlError } = yield __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].storage.from('files').getPublicUrl(fileName);
                    if (urlError) {
...
//# sourceMappingURL=_00h1p45._.js.map