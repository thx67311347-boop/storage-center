...
var useMegaStorage = ()=>{
    ...
    var uploadFileInternal = /*#__PURE__*/ function() {
        var _ref3 = _asyncToGenerator(function*(file, onProgress, abortController) {
            // 检查是否已取消
            if (abortController !== null && abortController !== void 0 && abortController.signal.aborted) {
                return null;
            }
            ...
            try {
                ...
                // 发送请求到本地API
                var response = yield fetch('/api/mega/upload', {
                    method: 'POST',
                    body: formData,
                ...
                if (!response.ok) {
                    ...
                    throw new Error("Upload failed with status ".concat(response.status, ": ").concat(errorText));
                }
        ...
        var _ref4 = _asyncToGenerator(function*(file, onProgress, abortController) {
            ...
            for(var retries = 0; retries < MAX_RETRIES; retries++){
                try {
                    ...
                    var result = yield uploadFileInternal(file, onProgress, abortController);
    ...
    var downloadFile = /*#__PURE__*/ function() {
        var _ref5 = _asyncToGenerator(function*(fileLink) {
            try {
                console.log("Downloading from Mega: ".concat(fileLink));
                // 发送请求到本地API
                var response = yield fetch("/api/mega/download?link=".concat(encodeURIComponent(fileLink)));
                if (!response.ok) {
    ...
    var deleteFile = /*#__PURE__*/ function() {
        var _ref6 = _asyncToGenerator(function*(fileLink) {
            try {
                ...
                // 发送请求到本地API
                var response = yield fetch("/api/mega/delete?link=".concat(encodeURIComponent(fileLink)), {
                    method: 'DELETE'
                });
                if (!response.ok) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$hooks$2f$useMegaStorage$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/hooks/useMegaStorage.ts [app-ssr] (ecmascript)");
function ownKeys(e, r) {
    var t = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
        var o = Object.getOwnPropertySymbols(e);
...
function FileManager() {
    ...
    var { uploadFile, isConnected, isLoading, connectToMega } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$hooks$2f$useMegaStorage$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMegaStorage"])();
...
//# sourceMappingURL=_0j3a702._.js.map